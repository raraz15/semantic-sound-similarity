...
if [ $# == 0 ]; then
    echo "Description: Takes extracted ImageBind model embeddings and prepares 
    them, searches for similarity, and performs the evaluation pipeline."
    echo "Usage: $0 param1 param2 param3 param4"
    echo "param1: ImageBind name (model name, string)"
...
# ImageBind Embeddings come aggregated
